...
public class DisputeAuthorization {
    ...
    private boolean isCardOwner(Dispute dispute, UUID userId) {
        return dispute.getTransaction().getCard() != null
                && dispute.getTransaction().getCard().getUser().getId().equals(userId);
    }
}
